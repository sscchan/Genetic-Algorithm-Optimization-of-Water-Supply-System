...
//Pump Modifier
 EXTERN int CALLTYPE ENgetNumberOfCurves();
 EXTERN void CALLTYPE ENgetCurveID(int curveIndex, char*bufferID);
 EXTERN int CALLTYPE ENsetPumpHeadFlowCurve(int linkIndex, int curveIndex);
 EXTERN int CALLTYPE ENsetPumpEffeciencyFlowCurve(int linkIndex, int curveIndex);
 EXTERN double CALLTYPE ENgetPumpCostPerDay(int linkIndex);
 EXTERN double CALLTYPE ENgetPumpEnergyUsage(int linkIndex);
#endif
